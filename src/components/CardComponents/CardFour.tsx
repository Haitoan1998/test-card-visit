      ...
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-black h-full flex flex-col justify-around gap-4">
          <div className="flex items-center gap-3 justify-center">
            ...
            <div>
             <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1 }}  className="text-xl text-nowrap lg:text-sm xl:text-xl font-bold text-white flex gap-2">Company name</motion.div>
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1.2 }} className="text-sm lg:text-xs xl:text-sm text-left mt-2 text-white font-bold">Designer</motion.div>
            </div>
          </div>
        </div>
      </div>
