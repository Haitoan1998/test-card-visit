          ...
          <div className="flex flex-col items-center lg:w-70 xl:w-70 2xl:w-100">
            ...
            <div className="w-full text-center">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1.4 }} className="text-xl font-bold text-black flex gap-2 text-center justify-center">
                <p className=" text-line line-clamp-1 text-xl lg:text-[10px] xl:text-[15px] 2xl:text-xl">{props.company || "Company Name"}</p>
              </motion.div>
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1.6 }} className="text-sm text-center text-black">
                <p className=" text-line break-words text-sm lg:text-[10px] xl:text-[12px] 2xl:text-sm">{props.job || "Job Title"}</p>
              </motion.div>
            </div>
          </div>
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1.6 }} className="absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center text-white text-center w-[50%]">
            <div className="w-full">
              <p className=" text-line font-light text-nowrap  text-sm lg:text-[10px] xl:text-[12px] 2xl:text-sm">{props.website || "Website"}</p>
            </div>
          </motion.div>
        </div>
      </div>
